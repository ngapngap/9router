...
const navItems = [
  ...
  { href: "/dashboard/mitm", label: "MITM", icon: "security", saasHidden: true },
  ...
  return (
    <div className="w-full max-w-lg rounded-xl bg-neutral-900/95 border border-white/10 p-6 text-white">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="text-lg font-semibold">Update RamRouter{latestVersion ? ` to v${latestVersion}` : ""}</h2>
